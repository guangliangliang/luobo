...
func _setup_ui() -> void:
	...
	var sep1: Control = _make_spacer(40)
	...
	var sep2: Control = _make_spacer(40)
	...
	var sep3: Control = _make_spacer(40)
	h_box.add_child(sep3)
	
	_monster_label = Label.new()
	_monster_label.add_theme_font_size_override("font_size", 20)
	...
	_start_wave_btn.offset_left = -170
	_start_wave_btn.offset_top = -65
	_start_wave_btn.offset_right = -20
	_start_wave_btn.offset_bottom = -15
	_start_wave_btn.add_theme_font_size_override("font_size", 20)
